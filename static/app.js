...
async function renderWarRoomMap(mapType) {
    ...
    // Size canvas based on map_rect for proper objective positioning
    if (useProperTransform && mapMeta && mapMeta.map_rect) {
        ...
        // Scale to reasonable canvas size while maintaining map_rect aspect ratio
    ...
    // Background image - use xMidYMid slice to fill canvas while maintaining aspect ratio
    if (bgUrls[mapType]) {
